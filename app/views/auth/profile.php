        ...
        <div class="container flex justify-between mx-auto">
            <div class="w-full lg:w-8/12">
                <div class="flex items-center justify-between">
                    <h1 class="text-xl font-bold text-gray-700 md:text-2xl">Update your profile</h1>
                </div>
                <div class="mt-6">
                    <form action="/"
                          method="post">
                        ...
                        <label for="oldpassword"
                               class="block<?= isset($_SESSION['errors']['password']) ? ' text-red-600' : '' ?> mt-8 mb-2">Old Password</label>
                        ...
                        <label for="newpassword"
                               class="block<?= isset($_SESSION['errors']['password']) ? ' text-red-600' : '' ?> mt-8 mb-2">New Password</label>
                        <?= isset($_SESSION['errors']['password']) ? '<p class="italic text-red-600">'.$_SESSION['errors']['password'].'</p>' : '' ?>
                        ...
                        <label for="verifypassword"
                               class="block<?= isset($_SESSION['errors']['password']) ? ' text-red-600' : '' ?> mt-8 mb-2">Verify New Password</label>
                        <?= isset($_SESSION['errors']['password']) ? '<p class="italic text-red-600">'.$_SESSION['errors']['password'].'</p>' : '' ?>
